...
class AdminUserRole extends \backend\models\BaseModel
{
    ...
    public function rules()
    {
        return [
            [['user_id'], 'required'],
            [['user_id', 'role_id', 'group_id'], 'integer'],
    ...
    {
        return $this->hasOne(AdminUserInfo::className(),['user_id'=>'user_id']);
    }

    public static function deleteAdminUserRole($ids =array()){
        $result = AdminUserRole::deleteAll([ 'user_id'=> $ids]);
        return $result;
    }
