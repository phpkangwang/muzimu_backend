...
class AdminModuleService extends AdminModule{
    ...
    public function getUserModuleList($userId=0)
    {
        $sql = "select 
                module.id as mid,
                module.display_label as mlb,
				func.id as fid,
				func.display_label as flb,
				func.entry_url as furl,
				sru1.right_id as rid,
				sr.display_label as rlb,
				sr.game as game,
				sru1.url,
				sru1.para_name,
				sru1.para_value
    ...
    public function getAllFunctions(){
        $sql = 'SELECT r.id AS right_id, r.menu_id, r.right_name, f.entry_url, f.menu_name, m.display_label,r.game
