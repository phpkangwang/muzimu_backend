 ...
 */
class MoneyAccount extends \backend\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            [['account_id'], 'required'],
            [['account_id'], 'integer'],
            [['wx_account', 'wx_nickname', 'ali_account', 'ali_nickname', 'bank_account', 'bank_type', 'bank_branch', 'bank_user'], 'string', 'max' => 255]
        ];
    }
