...
/**
 * This is the model class for table "fivepk_player_firephoenix_cardtypeandvalue".
 *
 ...
 */
class FivepkPlayerFirephoenixCardtypeandvalue extends \backend\models\BaseModel
{
    /**
     * @inheritdoc
     */
