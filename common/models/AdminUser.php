 ...
 */
class AdminUser extends \backend\models\BaseModel
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasOne(CollectAccount::className(),['id_user'=>'id']);
    }
...
//                         'dbType' => "int(11)",
                        ...
                        'type' => 'integer',
                        'unsigned' => false,
                        'label'=>$this->getAttributeLabel('white_list'),
                        'inputType' => 'text',
                        'isEdit' => true,
                        'isSearch' => false,
                        'isDisplay' => true,
